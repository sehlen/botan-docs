...
.. table::
   ...
   +----------------------+--------------------------------------------------------------------------------+
   | **Steps:**           | #. Execute the Botan 3.11 test case for PKSIG-ECDSA-3 (`ecdsa_all_groups`)     |
   |                      |                                                                                |
   |                      | #. Verify the observed behavior matches the expected output.                   |
   +----------------------+--------------------------------------------------------------------------------+
...
.. table::
   ...
   +----------------------+--------------------------------------------------------------------------------+
   | **Steps:**           | #. Execute the Botan 3.11 test case for PKSIG-ECDSA-5 (`ecdsa_sign_verify_der`)|
   |                      |                                                                                |
   |                      | #. Verify the observed behavior matches the expected output.                   |
   +----------------------+--------------------------------------------------------------------------------+
...
.. table::
   ...
   +----------------------+--------------------------------------------------------------------------------+
   | **Steps:**           | #. Execute the Botan 3.11 test case for PKSIG-ECDSA-6 (`ecdsa_key_recovery`)   |
   |                      |                                                                                |
   |                      | #. Verify the observed behavior matches the expected output.                   |
   +----------------------+--------------------------------------------------------------------------------+
