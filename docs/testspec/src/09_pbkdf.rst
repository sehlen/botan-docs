...
.. table::
   ...
   |                        |                                                                         |
   |                        |    Note: The Hash Function and MAC are embedded in the PBKDF algorithm  |
   |                        |    name (e.g., ``PBKDF2(HMAC(SHA-1))``), not passed as separate inputs  |
   |                        |                                                                         |
   ...
   |                        |    *Out*                                                                |
   |                        |                                                                         |
   |                        | #. Also derive the key using the ``PasswordHashFamily`` interface:      |
   |                        |    create a ``PasswordHashFamily`` for the algorithm, derive a          |
   |                        |    ``PasswordHash`` with the same *Iterations*, and compare the         |
   |                        |    resulting key with *Out*                                             |
   +------------------------+-------------------------------------------------------------------------+
...
.. table::
   ...
   |                        |    *Out*                                                                |
   |                        |                                                                         |
   |                        | #. Also verify key derivation via the ``PasswordHashFamily`` interface  |
   |                        |    using the same parameters and compare the result with *Out*          |
   +------------------------+-------------------------------------------------------------------------+
...
-  Output Length: 32 bytes - 320 bytes
